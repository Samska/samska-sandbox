...
They apply to the future v0.1 backend and its integrations. The current repository has applications in `backend/` and `web/`; these principles do not prescribe the frontend's feature structure.
